...
export class EventValidationService {
  ...
  validate(type:string,payload:Record<string,unknown>){
    if(!rules[type])throw new BadRequestException(`Unsupported event type: ${type}`);const value={...payload};this.oneOf(value,'team',teams);
