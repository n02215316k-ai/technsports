...
import { BookOpen, ClipboardCheck, Database, FileEdit, ShieldCheck, UserRound } from 'lucide-react';
...
export default function Account(){
  ...
  const tools=[
    {roles:['COLLECTOR','REVIEWER','EDITOR','ADMIN'],href:'/contribute',label:'Match assignments',icon:<ClipboardCheck/>},
    {roles:['COLLECTOR','REVIEWER','EDITOR','ADMIN'],href:'/contribute/transfers',label:'Transfer reports',icon:<BookOpen/>},
