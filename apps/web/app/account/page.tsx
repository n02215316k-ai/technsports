...
import { BookOpen, ClipboardCheck, Database, FileEdit, ShieldCheck, Ticket, UserCog, UserRound } from 'lucide-react';
...
export default function Account(){
  ...
  const tools=[
    ...
    {roles:['ADMIN'],href:'/admin/tickets',label:'Ticketing operations',icon:<Ticket/>},
